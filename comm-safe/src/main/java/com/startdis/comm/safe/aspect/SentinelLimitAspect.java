package com.startdis.comm.safe.aspect;
...
import com.startdis.comm.safe.annotation.SentinelLimit;
...
public class SentinelLimitAspect {
    ...
    @Pointcut(value = "@annotation(com.startdis.comm.safe.annotation.SentinelLimit)")
